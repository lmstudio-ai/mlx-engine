...
def ratchet_callback_wrapper(callback: Optional[Callable[[float], bool]]):
    """
...
def throw_to_stop_callback_wrapper(callback: Optional[Callable[[float], bool]]):
    """
...
def token_count_callback_wrapper(
...
def create_generator(
    ...
    *,
    ...
    prompt_progress_callback = ratchet_callback_wrapper(prompt_progress_callback)
    ...
    stream = stream_generate(
        ...
        prompt_progress_callback=token_count_callback_wrapper(
            throw_to_stop_callback_wrapper(prompt_progress_callback)
        ),
