...
class _TempSafetensorSpool:
    ...
    def put(
        ...
        min_capacity = self._safetensor_size_floor(arrays, metadata)
...
def _load_prompt_cache_from_file(file_obj, return_metadata=False):
...
class VlmPromptSpillCache:
    def __init__(self, model_config: Any = None):
        ...
        self._store = _TempSafetensorSpool(base_dir)
